...
resource "aws_nat_gateway" "nat_gateway_az1" {
  ...
  # to ensure proper ordering, it is recommended to add an explicit dependency , i.e when deleting nat gateway should be deleted first before internent gateway
